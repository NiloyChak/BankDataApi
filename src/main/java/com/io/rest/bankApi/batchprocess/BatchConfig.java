...
public class BatchConfig {
    ...
    public JdbcBatchItemWriter<Customer> writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<Customer>()
                ...
                .sql("INSERT INTO customer (customer_id, surname, credit_score, geography, gender, age, tenure, balance, has_cr_card, salary, satisfaction_score, card_type, points) VALUES (:customerId, :surname, :creditScore, :geography, :gender, :age, :tenure, :balance, COALESCE(NULLIF(:hasCrCard, ''), 'N'), :salary, :satisfactionScore, :cardType, :points)")
